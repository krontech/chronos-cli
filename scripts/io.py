...
class sequencer: # (pychronos.fpgamap)
    ...
    def __bitprop(offset, size, bitOffset, nBits, docstring):
        return property(fget=lambda self: ((self.regRead(offset, size) >> bitOffset) & (2**nBits-1)),
                        fset=lambda self, value: setPropertyBits(offset, size, bitOffset, nBits, value),
                        doc = docstring)
    def __bitprop_ro(offset, size, bitOffset, nBits, docstring):
        return property(fget=lambda self: ((self.regRead(offset, size) >> bitOffset) & (2**nBits-1)),
                        doc = docstring)

    def __sourceprop(offset, docstring):
    ...
    io1Source              = __sourceprop(0x20, 'io1 source')
    ...
    io2Source              = __sourceprop(0x22, 'io2 source')
    ...
    combOr1Source          = __sourceprop(0x24, 'combOr1 source')
    ...
    combOr2Source          = __sourceprop(0x26, 'combOr2 source')
    ...
    combOr3Source          = __sourceprop(0x28, 'combOr3 source')
    ...
    combAndSource          = __sourceprop(0x2A, 'combAnd source')
    ...
    combXOrSource          = __sourceprop(0x2C, 'combXOr source')
    ...
    delaySource            = __sourceprop(0x2E, 'delay source')
    ...
    toggleSetSource        = __sourceprop(0x30, 'toggleSet source')
    ...
    toggleClearSource      = __sourceprop(0x32, 'toggleClear source')
    ...
    toggleFlipSource       = __sourceprop(0x34, 'toggleFlip source')
    ...
    gateSource             = __sourceprop(0x36, 'gate source')
    ...
    startSource            = __sourceprop(0x38, 'start source')
    ...
    stopSource             = __sourceprop(0x3A, 'stop source')
    ...
    shutterSource          = __sourceprop(0x3C, 'shutter source')
    ...
    cpuIntSource           = __sourceprop(0x3E, 'cpuInt source')
    ...
    io1TimeSinceFaling       = __regprop_ro(0cC4, 4, 'time since falling edge')
    io2TimeSinceRising       = __regprop_ro(0xC0, 4, 'time since rising edge')
    io2TimeSinceFaling       = __regprop_ro(0cC4, 4, 'time since falling edge')
    startTimeSinceRising     = __regprop_ro(0xC0, 4, 'time since rising edge')
    startTimeSinceFaling     = __regprop_ro(0cC4, 4, 'time since falling edge')
    stopTimeSinceRising      = __regprop_ro(0xC0, 4, 'time since rising edge')
    stopTimeSinceFaling      = __regprop_ro(0cC4, 4, 'time since falling edge')
    shutterTimeSinceRising   = __regprop_ro(0xC0, 4, 'time since rising edge')
    shutterTimeSinceFaling   = __regprop_ro(0cC4, 4, 'time since falling edge')
    toggleTimeSinceRising    = __regprop_ro(0xC0, 4, 'time since rising edge')
    toggleTimeSinceFaling    = __regprop_ro(0cC4, 4, 'time since falling edge')
    interruptTimeSinceRising = __regprop_ro(0xC0, 4, 'time since rising edge')
    intteruptTimeSinceFaling = __regprop_ro(0cC4, 4, 'time since falling edge')
