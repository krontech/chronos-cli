...
extern void dbus_glib_marshal_cam_video_BOOLEAN__STRING_BOXED_POINTER (GClosure     *closure,
                                                                       GValue       *return_value,
...
void
dbus_glib_marshal_cam_video_BOOLEAN__STRING_BOXED_POINTER (GClosure     *closure,
